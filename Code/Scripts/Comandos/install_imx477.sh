...
nano_names["4.9.140-tegra-32.4.3-20200625213809"]="arducam-nvidia-l4t-kernel_4.9.140-32.4.3-20200904112010_arm64_imx477.deb"
nano_download_links["4.9.140-tegra-32.4.3-20200625213809"]="https://raw.githubusercontent.com/ArduCAM/MIPI_Camera/master/Jetson/IMX477/driver/Nano/arducam-nvidia-l4t-kernel_4.9.140-32.4.3-20200904112010_arm64_imx477.deb"

nano_names["4.9.140-tegra-32.4.4-20201016124427"]="arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201026143033_arm64_imx477.deb"
nano_download_links["4.9.140-tegra-32.4.4-20201016124427"]="https://github.com/ArduCAM/MIPI_Camera/releases/download/v0.0.1/arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201026143033_arm64_imx477.deb"
...
nano_names["4.9.140-tegra-32.4.4-20201027211359"]="arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201027211359_arm64_imx477.deb"
nano_download_links["4.9.140-tegra-32.4.4-20201027211359"]="https://github.com/ArduCAM/MIPI_Camera/releases/download/v0.0.1/arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201027211359_arm64_imx477.deb"

nano_names["4.9.201-tegra-32.5.0-20210115145440"]="arducam-nvidia-l4t-kernel_4.9.201-tegra-32.5.0-20210126142035_arm64_imx477.deb"
nano_download_links["4.9.201-tegra-32.5.0-20210115145440"]="https://github.com/ArduCAM/MIPI_Camera/releases/download/v0.0.1/arducam-nvidia-l4t-kernel_4.9.201-tegra-32.5.0-20210126142035_arm64_imx477.deb"


declare -A nx_download_links 
declare -A nx_names
nx_names["4.9.140-tegra-32.4.3-20200625213407"]="arducam-nvidia-l4t-kernel_4.9.140-32.4.3-20200721164156_arm64_imx477.deb"
nx_download_links["4.9.140-tegra-32.4.3-20200625213407"]="https://raw.githubusercontent.com/ArduCAM/MIPI_Camera/master/Jetson/IMX477/driver/XavierNx/arducam-nvidia-l4t-kernel_4.9.140-32.4.3-20200721164156_arm64_imx477.deb"

nx_names["4.9.140-tegra-32.4.4-20201016123640"]="arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201026143033_arm64_imx477.deb"
nx_download_links["4.9.140-tegra-32.4.4-20201016123640"]="https://github.com/ArduCAM/MIPI_Camera/releases/download/v0.0.1-nx/arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201026143033_arm64_imx477.deb"
...
nx_names["4.9.140-tegra-32.4.4-20201027211332"]="arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201027211332_arm64_imx477.deb"
nx_download_links["4.9.140-tegra-32.4.4-20201027211332"]="https://github.com/ArduCAM/MIPI_Camera/releases/download/v0.0.1-nx/arducam-nvidia-l4t-kernel_4.9.140-32.4.4-20201027211332_arm64_imx477.deb"

nx_names["4.9.201-tegra-32.5.0-20210115151051"]="arducam-nvidia-l4t-kernel_4.9.201-tegra-32.5.0-20210126142035_arm64_imx477.deb"
nx_download_links["4.9.201-tegra-32.5.0-20210115151051"]="https://github.com/ArduCAM/MIPI_Camera/releases/download/v0.0.1-nx/arducam-nvidia-l4t-kernel_4.9.201-tegra-32.5.0-20210126142035_arm64_imx477.deb"
...
if [ $content == "4.9.140-tegra-32.4.3-20200924161919" ]; then
	if [[ $JETSON_TYPE == *"Xavier NX"* ]]; then
		unzip 20200924161919.zip && sudo dpkg -i 20200924161919/XavierNx/arducam-nvidia-l4t-kernel_4.9.140-32.4.3-20201021145043_arm64_imx477.deb
	fi

	if [[ $JETSON_TYPE == *"Nano"* ]]; then
		unzip 20200924161919.zip && sudo dpkg -i 20200924161919/Nano/arducam-nvidia-l4t-kernel_4.9.140-32.4.3-20201021145043_arm64_imx477.deb
	fi
else
